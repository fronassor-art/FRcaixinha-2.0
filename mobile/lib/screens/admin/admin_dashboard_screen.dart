    ...
    return Scaffold(
      ...
      body: RefreshIndicator(onRefresh: load, child: ListView(padding: const EdgeInsets.all(16), children: [
        ...
        if (d != null) ...[
          ...
          ListTile(leading: const Icon(Icons.warning_amber_outlined), title: const Text('Inadimplência'), subtitle: const Text('Obrigações em aberto, atrasos, juros e multas'), trailing: const Icon(Icons.chevron_right), onTap: () => context.push('/admin/delinquency')),
