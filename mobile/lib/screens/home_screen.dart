    ...
    return Scaffold(
      ...
      body: RefreshIndicator(
        ...
        child: ListView(
          ...
          children: [
            Text(
              profile == null ? 'Carregando...' : 'Olá, ${profile!['name']}',
            ...
            Card(
              child: ListTile(
                ...
                subtitle: const Text('Consulte os lançamentos da sua conta.'),
                trailing: const Icon(Icons.chevron_right),
            ...
            Card(
              child: ListTile(
                ...
                subtitle: const Text('Veja apenas os seus dados financeiros.'),
                trailing: const Icon(Icons.chevron_right),
            ...
            Card(
              child: ListTile(
                ...
                subtitle: const Text('Avisos sobre vencimentos e pagamentos.'),
                trailing: const Icon(Icons.chevron_right),
                onTap:
                    () => Navigator.push(
                      context,
