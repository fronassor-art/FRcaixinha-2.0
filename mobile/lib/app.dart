...
GoRouter createRouter(AppState state) => GoRouter(
  ...
  redirect: (context, route) {
    ...
    final isPublic =
        route.matchedLocation == '/login' ||
        route.matchedLocation == '/register';
  ...
  routes: [
    ...
    GoRoute(
      path: '/contributions',
      builder: (_, __) => const ContributionsScreen(),
    ),
    GoRoute(
      path: '/notifications',
    ...
    GoRoute(
      path: '/communications',
      builder: (_, __) => const CommunicationCenterScreen(),
    ),
    ...
    GoRoute(
      ...
      builder:
          (_, state) =>
              LoanDetailScreen(loanId: int.parse(state.pathParameters['id']!)),
    ),
    GoRoute(path: '/admin', builder: (_, __) => const AdminDashboardScreen()),
    GoRoute(
      path: '/admin/contributions',
      builder: (_, __) => const AdminContributionsScreen(),
    ),
    GoRoute(
      path: '/admin/operations',
      builder: (_, __) => const OperationsDashboardScreen(),
    ),
    GoRoute(
    ...
    GoRoute(
      ...
      builder: (_, __) => const GovernanceDashboardScreen(),
    ),
    GoRoute(
      path: '/admin/reports',
    ...
    GoRoute(
      path: '/admin/financial-projection',
      builder: (_, __) => const FinancialProjectionScreen(),
    ),
    GoRoute(
      path: '/admin/capacity-optimizer',
      builder: (_, __) => const CapacityOptimizerScreen(),
    ),
    GoRoute(
    ...
    GoRoute(
      ...
      builder: (_, __) => const OperationalControlScreen(),
    ),
    GoRoute(
      path: '/admin/workflow-compliance',
      builder: (_, __) => const WorkflowComplianceScreen(),
    ),
    GoRoute(
      path: '/admin/executive-risk-response',
      builder: (_, __) => const ExecutiveRiskResponseScreen(),
    ),
    GoRoute(
      path: '/admin/executive-risk-decisions',
      builder: (_, __) => const ExecutiveRiskDecisionScreen(),
    ),
    GoRoute(
      path: '/admin/executive-risk-governance',
      builder: (_, __) => const ExecutiveRiskGovernanceScreen(),
    ),
    GoRoute(
      path: '/admin/executive-risk-execution',
      builder: (_, __) => const ExecutiveRiskExecutionScreen(),
    ),
    GoRoute(
      path: '/admin/continuous-improvement-dashboard',
      builder: (_, __) => const ContinuousImprovementDashboardScreen(),
    ),
    GoRoute(
      path: '/admin/continuous-improvement-balancing',
      builder: (_, __) => const ContinuousImprovementBalancingScreen(),
    ),
    GoRoute(
      path: '/admin/continuous-improvement-finalization',
      builder: (_, __) => const ContinuousImprovementFinalizationScreen(),
    ),
  ],
);
